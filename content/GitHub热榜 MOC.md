...
| msitarzewski/agency-agents | 7 | 08-13 |
...
| jdx/mise | 1 | 08-08 |
| semantica-agi/semantica | 4 | 08-13 |
...
- #边缘部署 — Self-Hosting-Guide, turso（进程内SQL数据库）, CasaOS（个人云系统）, project-nomad（离线AI生存计算机）, cactus-compute/needle（14MB端侧基础模型）
