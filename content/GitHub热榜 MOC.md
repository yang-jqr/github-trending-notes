...
| rohitg00/ai-engineering-from-scratch | 8 | 08-27 |
...
| diegosouzapw/omniroute | 7 | 08-27 |
...
| nousresearch/hermes-agent | 7 | 08-26 |
...
| tauricresearch/tradingagents | 5 | 08-27 |
...
| anthropics/claude-plugins-official | 4 | 08-27 |
| apache/maka | 4 | 08-27 |
| can1357/oh-my-pi | 4 | 08-27 |
...
| freestylefly/awesome-gpt-image-2 | 4 | 08-27 |
| github/copilot-sdk | 4 | 08-02 |
| github/spec-kit | 4 | 08-27 |
...
| agricidaniel/claude-obsidian | 3 | 08-27 |
...
| dietrichgebert/ponytail | 3 | 08-27 |
...
| langchain-ai/deepagents | 2 | 08-26 |
...
| conardli/garden-skills | 1 | 08-27 |
...
| k-dense-ai/scientific-agent-skills | 1 | 08-27 |
...
- #Agent记忆 — cognee（自托管知识图谱记忆引擎）, EverMind-AI/EverOS（跨平台可移植Agent记忆层）, TencentDB-Agent-Memory（4层渐进式记忆pipeline）, semantica（图原生记忆）, ai-memory（跨agent厂商长期记忆交接）, volcengine/OpenViking（自进化上下文数据库），MemPalace/mempalace（开源AI记忆系统，benchmark最强宣称）
...
- #多模型统一接口 — aisuite（一行代码切模型，吴恩达出品）, freellmapi（16家LLM免费额度聚合代理）, Wei-Shaw/sub2api（订阅统一接入中转），Alishahryar1/free-claude-code（1.3B免费token聚合网关），diegosouzapw/OmniRoute（多供应商路由/负载均衡/故障转移网关，你正在用）
...
- #Agent浏览器 — ego-lite（AI Agent专用浏览器，共享登录态）, browser-use/browser-use（agent操作浏览器的开源库）
