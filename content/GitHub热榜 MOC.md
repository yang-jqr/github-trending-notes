...
| crosstalk-solutions/project-nomad | 4 | 09-22 |
...
| open-dev-society/openstock | 3 | 09-22 |
...
| anthropics/financial-services | 2 | 09-22 |
| antirez/ds4 | 2 | 08-04 |
...
| builderio/agent-native | 2 | 09-22 |
...
| oven-sh/bun | 1 | 07-11 |
| owainlewis/awesome-artificial-intelligence | 1 | 09-22 |
...
- #AIGC视频 — MoneyPrinterTurbo, OpenMontage, hyperframes（HTML-to-Video Agent范式）, manim（数学动画引擎）, LTX-2（音视频生成模型推理包）, OpenCut（开源CapCut替代品）, hpcaitech/Open-Sora（开源视频生成，潞晨）, zhouxiaoka/autoclip（AI 高光提取与二创剪辑：转写→打分→切片流水线）, krillinai/OpenCreator（Codex 驱动的开源 AI 创作工作台：视频/图像/语音/数字人/翻译）
